...
<body data-no-turbolink="" id="web-general-dm4">
  <div class="dm">
    <div class="top-container">
      <img width="100%" class="top-back" src="./resource/699/699yuan.png" alt="Top bg">
    </div>
    <div id="fixed-bottom-nav">
      <div class="fixed-box" style="display: block;">
        <a href="http://www.youyoucode.cn/wx/pay/jsapi699.php" target="_blank">
          <img  width="100%" height="100%" src="./resource/699/jiage699.jpg">
        </a>
      </div>
    </div>
  </div>
  ...
  wx.ready(function () {
    ...
    wx.onMenuShareTimeline({
        title: "码力青少儿编程-常规班",  
        link: "http://www.youyoucode.cn/wx/699.php",  
    ...
    wx.onMenuShareAppMessage({
        ...
        title: "码力编程暑假特惠|￥699元16节，在家学人工智能语言",
        link: "http://www.youyoucode.cn/wx/699.php",
        imgUrl: "http://www.youyoucode.cn/wx/resource/apple-touch-icon.png",  
        type: 'link',  
        dataUrl: '',  
