...
$input->SetTotal_fee("19900");
$input->SetTime_start(date("YmdHis"));
$input->SetTime_expire(date("YmdHis", time() + 600));
$input->SetGoods_tag("test");
$input->SetNotify_url("/wx/pay/notify.php");
...
<body style="background-color: #f0eff5;">
	...
	<div style="position:absolute; left:0px; top:32px; width:100%; height: 130px; background-color: #ffffff;">
		<div align="center" style="font-size:18px; line-height:12px">
			...
			<font color="#60706f">青少儿趣味编程 - <b>2018暑假班</b></font><br/><br/>
			<font color="#60706f" style="font-size:16px;">L0零基础班 第六期</font><br/><br/>
			<font color="#60706f" style="font-size:18px;">付款后课程老师会立即联系您</font>
		</div>
	</div>
	<div style="position:absolute; left:0px; top:162px; width:100%;">
		<div align="center">
			<br/><font color="#000">本次订单需支付 ￥<b><span style="font-size:47px">199</span></b>元</font><br/><br/>
			<button style="width:250px; height:55px; border-radius: 6px;background-color:#0bbc0a; border:0px #FE6714 solid; cursor: pointer;  color:white;  font-size:19px;" type="button" onclick="show_prompt()">
				立即支付
			</button>
		</div>
	</div>
