...
<body data-no-turbolink="" id="web-general-dm4">
  <div class="dm">
    ...
    <div class="p1-container">
      ...
      <div class="over">
        <div class="video-container-2">
          <video id="video_id2" autoplay="" controls="1" id="mainPlayer" playsinline="" poster="./resource/dm-preview-15.jpg" src="./resource/videos/DM2.mp4" webkit-playsinline="" width="auto"></video>
        </div>
      </div>
    </div>
    ...
    <div id="fixed-bottom-nav">
      <div class="fixed-box" style="display: block;">
        <a href="http://www.youyoucode.cn/regular/pay/jsapi.php" target="_blank">
  ...
  <script>
  document.getElementById("video_id2").style.top = Math.floor(window.innerWidth*4388/750)+"px";
  document.getElementById("video_id2").style.left = Math.floor(window.innerWidth*40/750)+"px";
  document.getElementById("video_id").style.top = Math.floor(window.innerWidth*640/750)+"px";
  ...
  regular.ready(function () {
    ...
    regular.onMenuShareTimeline({
        title: "码力青少儿编程-暑假班",  
        link: "http://www.youyoucode.cn/regular/",  
        imgUrl: "http://www.youyoucode.cn/regular/resource/apple-touch-icon.png",  
        success: function () {
